...
public class VehicleRegisterTest {
    ...
    void createNewVehicleTest(){
        ...
        Vehicle vehicle = vr.createNewVehicle(VehicleType.m1, registrationNumber, registrationDate, make, model, vehicleColour, engineNumber, numberOfSeeats, massInService, maxMass, brakedTrailer, unBreakedTrailer, vehicleMotorEmissionType, owner);
